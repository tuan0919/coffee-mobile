...
import com.nlu.packages.request.cart.CartItemRequestDTO;
...
public interface ApiService {
    ...
    ApiService api = new Retrofit.Builder()
            .baseUrl("http://10.0.117.87:8888/api/")
    ...
    @PUT("v2/gio-hang")
    Call<CartItemRequestDTO> addCart(@Body CartItemRequestDTO cartItemRequestDTO);
